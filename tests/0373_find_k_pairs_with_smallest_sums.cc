...
TEST(FIND_K_PAIRS_WITH_SMALLEST_SUMS, EXAMPLE_TEST) {
    auto res1 = Solution::k_smallest_pairs({1, 7, 11}, {2, 4, 6}, 3);
    ...
    auto res2 = Solution::k_smallest_pairs({1, 1, 2}, {1, 2, 3}, 2);
    ASSERT_THAT(res2[0], testing::ElementsAre(1, 1));
    ASSERT_THAT(res2[1], testing::ElementsAre(1, 1));
    auto res3 = Solution::k_smallest_pairs({1, 2}, {3}, 3);
